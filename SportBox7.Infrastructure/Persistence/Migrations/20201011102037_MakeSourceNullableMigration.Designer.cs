...
namespace SportBox7.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20201011102037_MakeSourceNullableMigration")]
    partial class MakeSourceNullableMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SportBox7.Infrastructure.Identity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SportBox7.Infrastructure.Identity.User", b =>
                {
                    b.HasOne("SportBox7.Domain.Models.Editors.Editor", "Editor")
                        .WithOne()
                        .HasForeignKey("SportBox7.Infrastructure.Identity.User", "EditorId")
